...
public class FileIO {
	...
	public Automobile parsePropertyFile(Properties props){
		/*
		...
		*/
		...
		String carModel = props.getProperty("CarModel");//This is how you read a property. It is like getting a value from HashTable
		if(!carModel.equals(null))
		{
			auto.setModel(carModel);
			auto.setMake(props.getProperty("CarMake"));
			auto.setBasePrice(Integer.parseInt(props.getProperty("BasePrice")));
			auto.addOptionSet(props.getProperty("Option1"));
			auto.addOption(auto.getOptionSet(0), props.getProperty("OptionValue1a"), Integer.parseInt(props.getProperty("OptionPrice1a")));
			auto.addOption(auto.getOptionSet(0), props.getProperty("OptionValue1b"), Integer.parseInt(props.getProperty("OptionPrice1b")));
			auto.addOption(auto.getOptionSet(0), props.getProperty("OptionValue1c"), Integer.parseInt(props.getProperty("OptionPrice1c")));
			...
			auto.addOption(auto.getOptionSet(1), props.getProperty("OptionValue2a"), Integer.parseInt(props.getProperty("OptionPrice2a")));
			auto.addOption(auto.getOptionSet(1), props.getProperty("OptionValue2b"), Integer.parseInt(props.getProperty("OptionPrice2b")));

			auto.addOptionSet(props.getProperty("Option3"));
			auto.addOption(auto.getOptionSet(2), props.getProperty("OptionValue3a"), Integer.parseInt(props.getProperty("OptionPrice3a")));
			auto.addOption(auto.getOptionSet(2), props.getProperty("OptionValue3b"), Integer.parseInt(props.getProperty("OptionPrice3b")));
			auto.addOption(auto.getOptionSet(2), props.getProperty("OptionValue3c"), Integer.parseInt(props.getProperty("OptionPrice3c")));

			auto.addOptionSet(props.getProperty("Option4"));
			auto.addOption(auto.getOptionSet(3), props.getProperty("OptionValue4a"), Integer.parseInt(props.getProperty("OptionPrice4a")));
			auto.addOption(auto.getOptionSet(3), props.getProperty("OptionValue4b"), Integer.parseInt(props.getProperty("OptionPrice4b")));

			auto.addOptionSet(props.getProperty("Option5"));
			auto.addOption(auto.getOptionSet(4), props.getProperty("OptionValue5a"), Integer.parseInt(props.getProperty("OptionPrice5a")));
			auto.addOption(auto.getOptionSet(4), props.getProperty("OptionValue5b"), Integer.parseInt(props.getProperty("OptionPrice5b")));
