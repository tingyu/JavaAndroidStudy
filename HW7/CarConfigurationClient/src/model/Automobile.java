...
public class Automobile implements java.io.Serializable {
	...
	public String getOptionName(OptionSet tmp, int index) {
		return tmp.getOption(index).getName();
	}
	...
	public ArrayList<String> getAllOptionName(String opsetName){
		ArrayList<String> s = new ArrayList<String>();
		s = findOptionSet(opsetName).getAllOptionName();
		return s;
	}
	...
	public int getChoicePrice(String opsetName){
		return findOptionSet(opsetName).getOptionChoice().getPrice();
	}
	...
	public int getOptionPrice(String opsetName, String optName){
		System.out.println("opsetName = " + opsetName + " optName = " + optName);
		OptionSet obj = findOptionSet(opsetName);
		if (obj == null) {
			return -1;
		}
		return findOptionSet(opsetName).findOption(optName).getPrice();
	}
