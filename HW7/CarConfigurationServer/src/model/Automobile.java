...
import database.OptionDB;
import database.OptionSetDB;
...
public class Automobile implements java.io.Serializable {
	...
	public ArrayList<String> getOpsetNameList(){
		ArrayList<String> array = new ArrayList<String>();
		for(OptionSet tmp: opset){
			array.add(tmp.getName());
			
		}
		return array;
	}
	
	public ArrayList<String> getOptNameList(int index){
		ArrayList<String> array = new ArrayList<String>();
		array = opset.get(index).getOptNameList();
		return array;
	}
	
	public ArrayList<Integer> getOptPriceList(int index){
		ArrayList<Integer> array = new ArrayList<Integer>();
		array = opset.get(index).getOptPriceList();
		return array;
	}
