...
public class Driver {
	public static void main(String[] args) {
		...
		//This test insert function(create) in Automobile, OptionSet and Option
		BuildAuto auto = new BuildAuto();
		auto.buildAuto("FordZTW.txt","Txt");
		//auto.printAuto("Focus Wagon ZTW");
		
		//Test Update
		auto.updateOption(1, 1, "red", 200);
		auto.updateAutomobile("Focus Wagon ZTW", "hahah", 12000, "so");
		
		//Test delete
		auto.deleteOption("Focus Wagon ZTW", 1, 2);
		
		
		//fio.serializeAuto(auto);		
		/*
